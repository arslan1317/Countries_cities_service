...
module.exports = function _Server(options) {
    ...
    const defaultInitialization = () => {
        ...
        _server.decorateRequest('clientUuid', null);
        _server.decorateRequest('clientTokenId', null);
        _server.decorateRequest('userTokenId', null);
    ...
    const defaultMiddleware = () => {
        ...
        _server.register(fastifyStatic, {
